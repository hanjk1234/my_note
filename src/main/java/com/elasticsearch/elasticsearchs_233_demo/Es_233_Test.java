package com.elasticsearch.elasticsearchs_233_demo;
    ...
    public static void main(String[] dfd) {
        ...
        try {
           ...
           // Es_233_Utils.writeSearchResponse(searchResponse);
            ...
            SearchRequestBuilder builder =es_233_search.builderSearchRequestBuilderByIndex("message", "recent_ezsonar_2014-07-24_11-02")
