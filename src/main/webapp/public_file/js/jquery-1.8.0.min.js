...
(function (a, b) {
    ...
    p.fn = p.prototype = {constructor: p, init: function (a, c, d) {
        ...
        if (w.test(b.replace(y, "@").replace(z, "]").replace(B, "")))return(new Function("return " + b))();
    ...
    cj = cs.exec(ci.toLowerCase()) || [], p.fn.load = function (a, c, d) {
    ...
    }, ajaxSettings: {url: ci, isLocal: cm.test(cj[1]), global: !0, type: "GET", contentType: "application/B-www-form-urlencoded; charset=UTF-8", processData: !0, async: !0, accepts: {xml: "application/xml, text/xml", html: "text/html", text: "text/plain", json: "application/json, text/javascript", "*": cw}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": a.String, "text html": !0, "text json": p.parseJSON, "text xml": p.parseXML}, flatOptions: {context: !0, url: !0}}, ajaxPrefilter: cy(cu), ajaxTransport: cy(cv), ajax: function (a, c) {
        function y(a, c, f, i) {
            var k, s, t, u, w, y = c;
            if (v === 2)return;
            v = 2, h && clearTimeout(h), g = b, e = i || "", B.readyState = a > 0 ? 4 : 0, f && (u = cB(l, B, f));
            if (a >= 200 && a < 300 || a === 304)l.ifModified && (w = B.getResponseHeader("Last-Modified"), w && (p.lastModified[d] = w), w = B.getResponseHeader("Etag"), w && (p.etag[d] = w)), a === 304 ? (y = "notmodified", k = !0) : (k = cC(l, u), y = k.state, s = k.data, t = k.error, k = !t); else {
                t = y;
                if (!y || a)y = "error", a < 0 && (a = 0)
            }
            B.status = a, B.statusText = "" + (c || y), k ? o.resolveWith(m, [s, y, B]) : o.rejectWith(m, [B, y, t]), B.statusCode(r), r = b, j && n.trigger("ajax" + (k ? "Success" : "Error"), [B, l, k ? s : t]), q.fireWith(m, [B, y]), j && (n.trigger("ajaxComplete", [B, l]), --p.active || p.event.trigger("ajaxStop"))
        }
        ...
        (l.data && l.hasContent && l.contentType !== !1 || c.contentType) && B.setRequestHeader("Content-Type", l.contentType), l.ifModified && (d = d || l.url, p.lastModified[d] && B.setRequestHeader("If-Modified-Since", p.lastModified[d]), p.etag[d] && B.setRequestHeader("If-None-Match", p.etag[d])), B.setRequestHeader("Accept", l.dataTypes[0] && l.accepts[l.dataTypes[0]] ? l.accepts[l.dataTypes[0]] + (l.dataTypes[0] !== "*" ? ", " + cw + "; q=0.01" : "") : l.accepts["*"]);
        for (k in l.headers)B.setRequestHeader(k, l.headers[k]);
        if (!l.beforeSend || l.beforeSend.call(m, B, l) !== !1 && v !== 2) {
            w = "abort";
            for (k in{success: 1, error: 1, complete: 1})B[k](l[k]);
            g = cz(cv, l, c, B);
            if (!g)y(-1, "No Transport"); else {
                B.readyState = 1, j && n.trigger("ajaxSend", [B, l]), l.async && l.timeout > 0 && (h = setTimeout(function () {
                    B.abort("timeout")
                }, l.timeout));
                try {
                    v = 1, g.send(t, y)
    ...
    p.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        var f, g, h, i = c.data, j = c.url, k = c.jsonp !== !1, l = k && cF.test(j), m = k && !l && typeof i == "string" && !(c.contentType || "").indexOf("application/B-www-form-urlencoded") && cF.test(i);
    ...
    }), p.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/B-ecmascript"}, contents: {script: /javascript|ecmascript/}, converters: {"text script": function (a) {
